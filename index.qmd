...
pagetitle: Sparsity support in tidymodels, faster and less memory hungry models
echo: true
...
Memory allocated: [**82 GB**]{.fragment fragment-index=5}

:::
::: {.column}
### Today

runtime: [[**100**]{.fragment fragment-index=2}]{.fragment .strike fragment-index=3} [ **4** ]{.fragment .spacer  fragment-index=4} [**seconds**]{.fragment fragment-index=2}

Memory allocated: [**822 MB**]{.fragment fragment-index=5}
...
- automatic toggle can be turned off or on manually by setting [`sparse = "no"`]{.text-yellow} or [`"yes"`]{.text-yellow} in relevant steps
